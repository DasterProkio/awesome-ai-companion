...
- [binaural-voice](https://github.com/Saekisui/binaural-voice) - Binaural stereo rendering for mono TTS using near-field KU100 HRIR: moves audio around the listener via inline position cues. MIT. `Python` · `CLI` · `ready`.
