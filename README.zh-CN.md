...
- [YSClaude](https://github.com/winter-bit-cry/YSClaude) - Expo/React Native 的 Android 优先陪伴应用：以聊天为主入口，本地 SQLite 长期记忆、工具调用、MCP、网页交互、阅读、音乐、专注、日报、来信，以及悬浮球/无障碍屏幕感知/SSH 等 Kotlin 原生模块。`TypeScript` · `Android` · `adapt`
